...
There are private, intra (private w/o Internet access) subnets, and VPN Gateways created in each availability zone.

## Usage

Modify main.tf to change AZ, CIDR block, subnets...
